...
Function Install-Lab {
    ...
    process
    {
        ...
        $ExistingManagementAdapter = Get-VMNetworkAdapter `
            ...
            -Name $ManagementSwitchName `
            -ErrorAction Stop
        $ExistingVlan = (Get-VMNetworkAdapterVlan -VMNetworkAdapter (Get-VMNetworkAdapter -ManagementOS -Name $ManagementSwitchName)).AccessVlanID
       ...
       Set-VMNetworkAdapterVlan -VMNetworkAdapter (Get-VMNetworkAdapter -ManagementOS -Name $ManagementSwitchName) -Access -VlanId $ManagementVlan
